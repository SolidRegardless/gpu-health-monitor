...
-- NOTE: Continuous aggregates (1min, 5min, 1hour) are created in 02_aggregates.sql
-- They are NOT regular tables - they are materialized views with automatic refresh policies.
-- This ensures TimescaleDB properly optimizes them for fast time-series queries.
